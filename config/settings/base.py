...
MARKET_DATA_CRYPTO_ASSET_CHANGES_STREAM_KEY = env(
    "MARKET_DATA_CRYPTO_ASSET_CHANGES_STREAM_KEY",
    default="market_data:crypto:asset_changes",
)
MARKET_DATA_CRYPTO_ASSET_CHANGES_MAXLEN = env.int(
    "MARKET_DATA_CRYPTO_ASSET_CHANGES_MAXLEN",
    default=1000,
)
MARKET_DATA_CRYPTO_ASSET_CHANGES_READ_BLOCK_MS = env.int(
    "MARKET_DATA_CRYPTO_ASSET_CHANGES_READ_BLOCK_MS",
    default=5000,
)
MARKET_DATA_CRYPTO_ASSET_CHANGES_READ_COUNT = env.int(
    "MARKET_DATA_CRYPTO_ASSET_CHANGES_READ_COUNT",
    default=100,
)
MARKET_DATA_CRYPTO_ASSET_CHANGES_PUBLISH_TIMEOUT_SECONDS = env.float(
